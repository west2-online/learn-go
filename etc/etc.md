## 入门
1. [「2022 版」轻松搞定 Go 开发环境](https://polarisxu.studygolang.com/posts/go/2022-dev-env/)

## 基础
1. [掌握 Golang Interface：让你的代码如虎添翼](https://juejin.cn/post/7224654430921850936)
...
2. [dynamicgo 开源 ：基于原始字节流的高性能+动态化 Go 数据处理](https://mp.weixin.qq.com/s/Cm7CXxhxRfACf4djhinDew)
...
2. [浅谈在代理环境中的DNS解析行为](https://blog.skk.moe/post/what-happend-to-dns-in-proxy/)
